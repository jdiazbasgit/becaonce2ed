...
console.log(`El señor ${oscar.nombre} ${oscar.apellidos} con documento ${oscar.dni} tiene ${oscar.DatosPersonales.Hijo.chicos} hijos ${oscar.DatosPersonales.Hijo.chicas} hijas y estado civil de ${oscar.DatosPersonales.EstadoCivil} ocupa el cargo de ${oscar.DatosLaborales.Cargo} y tiene un sueldo de ${oscar.DatosLaborales.salario} trabaja en la empresa ${oscar.Empresa.nombre} con un CIF ${oscar.Empresa.cif}`)
console.log (oscar)