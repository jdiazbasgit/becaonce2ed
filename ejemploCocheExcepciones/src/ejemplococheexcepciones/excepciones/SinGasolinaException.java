...
public class SinGasolinaException extends Exception {
	 ...
	 */
	public SinGasolinaException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause es la causa de la excepción
	 */
	public SinGasolinaException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public SinGasolinaException(String message, Throwable cause, boolean enableSuppression,
