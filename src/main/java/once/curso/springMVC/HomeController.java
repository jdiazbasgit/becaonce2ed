...
public class HomeController {
	...
	public String listado(Model model) {
		...
		List<DatosPersonles> datosPersonales = new ArrayList<DatosPersonles>();
		for (int i = 0; i <= 30; i++) {

			datosPersonales.add(new DatosPersonles("fulanito" + i, "montes" + i, "98765413" + i));
