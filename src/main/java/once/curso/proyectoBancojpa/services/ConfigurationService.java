...
import once.curso.proyectoBancojpa.repositories.ConfigurationRepository;
...
public class ConfigurationService {
	...
	public void dameTiempoReal() {

		Iterable<Configuration> tiempoReal = getConfigurationRepository().findAll();
		for (Configuration configuration : tiempoReal) {
