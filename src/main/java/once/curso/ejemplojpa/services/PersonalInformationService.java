...
public class PersonalInformationService {
	...
	public void dameInformacionPersonal() {
		
		Iterable<PersonalInformation> informacionPers = getPersonalInformationRepository().findAll();
		for (PersonalInformation personalInformation : informacionPers) {
