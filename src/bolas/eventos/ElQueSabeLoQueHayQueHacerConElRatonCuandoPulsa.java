...
public class ElQueSabeLoQueHayQueHacerConElRatonCuandoPulsa implements MouseListener{

	private VentanaBolasConMouse vbr;

	public ElQueSabeLoQueHayQueHacerConElRatonCuandoPulsa(VentanaBolasConMouse vbr) {
		this.vbr = vbr;
	}

	@Override
	public void mouseClicked(MouseEvent e) {
		Bola bola = new Bola(e.getX(), e.getY(), generarIncremento(), generarIncremento(), 
				generarOrientacion(), generarOrientacion(), generarDimension(), (e.getButton() == 3) ? Color.BLUE : Color.GREEN);
	...
	public VentanaBolasConMouse getVbr() {
		return vbr;
	}

	public void setVbr(VentanaBolasConMouse vbr) {
		this.vbr = vbr;
	}
}
